test_that("package identity and public API are GQR", {
  expect_identical(as.character(utils::packageVersion("GQR")), "0.1.2")
  ...
  expected <- c(
    ...
    "gqr_regress_statements", "gqr_transform_data", "gqr_file_provenance",
    "gqr_reproducible_script", "run_gqr"
  )
